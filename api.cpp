...
// // 设置你的 API Token
// const std::string token = "sk-18dd5aae24f94f3fac901c2508fe91b9";
...
//         application/json"); headers = curl_slist_append(headers, "Accept:
//         application/json"); headers = curl_slist_append(headers,
//         Auth.c_str());
...
//         request_body_dump.c_str()); curl_easy_setopt(curl,
//         CURLOPT_WRITEFUNCTION, write_callback); curl_easy_setopt(curl,
//         CURLOPT_WRITEDATA, &response_data); curl_easy_setopt(curl,
//         CURLOPT_POST, 1L);
